...
class Avatar extends React.Component {
    ...
    componentDidMount = async() => {
        console.log(this.props.id, 'in avatarrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr');
        if(this.props.admin) {
        ...
        <div className="row t2_sp_avatar_container">
            <div className="col-md-10">
                <div className="t2_sp_avatar_img">
                    <img alt="avatar.png" src={this.state.avatar && this.state.avatar!== '' ? this.state.avatar : avatar} width="80px" height="auto" style={{borderRadius: '50%'}} 
                    // onClick={this.openModal1}
                    />
                    <img src={edit_badge} alt="badge.png" className="t2_sp_avatar_badge" style={{display: this.state.badge?"block":"false"}} 
                    // onClick={this.openModal1}
                    />
                </div>
                <div className="row t2_sp_avtar_desc">
                    <p className="col-12 t2_sp_avatar_txt1"> {this.state.name ? this.state.name : "loading..."} </p>
                    <p className="col-12 t2_sp_avatar_txt2">
                        <span style={{marginRight: 12}}><img alt="place" width="13px" height="16px" src={place}/></span>
                        {this.state.location ?  this.state.location.name + ' ,' + this.state.location.state : 'loading...'}
                    </p>
                </div>
            </div>
            {/* <div className="col-md-2">
                <div className="col-12 t2_sp_avatar_txt1" > Hired </div>
            </div> */}
            <div className="col-md-2">
                    <p className="col-12 t2_sp_avatar_txt1"> {'Joined'} </p>
                    <p className="col-12 t2_sp_avatar_txt2">
                        {/* <span style={{marginRight: 12}}><img alt="place" width="13px" height="16px" src={place}/></span> */}
                        {this.state.createdAt ?  moment(this.state.createdAt).format('MM/DD/YYYY') : 'loading...'}
                    </p>
                </div>
