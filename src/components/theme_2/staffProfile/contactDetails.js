...
class ContactDetails extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    console.log(
      this.props.id,
      "in contact detailssssssssssssssssssssssssssssssssss"
    );
    if (this.props.admin) {
    ...
    if (res.data) {
      ...
      console.log(res.data, "in mountttttttttttttttttttttttttttttttttttttttt");
    }
  };
      ...
      <div className="t2_sp_work">
        ...
        <div className="row t2_sp_work_container">
          <div className="col-md-6 col-sm-12">
            ...
            <h5 className="t2_detail_textbox" title={this.state.name}>
              {this.state.name}{" "}
            </h5>
          ...
          <div className="col-md-6 col-sm-12">
            ...
            <h5 className="t2_detail_textbox" title={this.state.jobTitle}>
              {this.state.jobTitle}
            </h5>
            <hr style={{ marginTop: 24 }} />
          </div>
          ...
          <div className="col-md-6 col-sm-12">
            ...
            <h5 className="t2_detail_textbox">
              {/* { temp1 + '-' + temp2 + '-' + temp3 }  */}
              {this.state.phone}
            </h5>
            <hr style={{ marginTop: 24 }} />
