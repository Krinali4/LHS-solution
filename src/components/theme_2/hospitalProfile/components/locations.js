  ...
  render() {
    return (
        <div className="t2_sp_work" style={{marginBottom: 30}}>
                ...
                <table style={{minWidth: '800px', marginBottom: '12px', padding: 0}}>
                    <thead>
                        <tr className="nurseHead">
                            ...
                            {this.state.isAdmin ? '' :   <th className="locTh" style={{width: '80px'}}> Action </th> }
                        </tr>
                    </thead>
                    <tbody>
                        <tr style={{height: 18}}/>
                            ...
                            this.state.corporateAddress.map((item) => {
                                return  <tr key={item.num} className="locRow" style={{height: '60px'}}>
                                   ...
                                   {this.state.isAdmin ? '' :          <td> 
                                                ...
                                                <span><img width="18px" height="15px" style={{cursor: 'pointer', display: 'inline'}} alt="img"src={del} onClick={() => this.confirmDeleteOne(item.num)}/></span> 
                                            </td>}
                                        </tr>
                            })
                        }                    
         ...
         {this.state.isAdmin ? '' :    <div className="ssu2_addItem" onClick={this.addNewLoc}>
