   ...
   render() {
    return (
        <div className="t2_sp_work">
            ...
            {this.state.isAdmin ? '' :     <img alt="icon.svg" src={edit_note} width="18px" style={{marginTop: 4, float: 'right', cursor: 'pointer'}} onClick={this.editAddress}/>}
            </div>
