...
class Contact extends React.Component {
    ...
    componentWillMount = async () => {
      ...
      console.log(this.props.email, 'at mounting after setstate');
    ...
    componentWillReceiveProps = (newProps) => {
      ...
      console.log(this.props.email, 'at recieveprops after setstate');
    ...
    return (
        <div className="t2_sp_work">
            <div className="t2_sp_work_title">
                Contact Details
           {this.state.isAdmin ? '' :      <img alt="icon.svg" src={edit_note} style={{width: 18, marginTop: 4, float: 'right', cursor: 'pointer'}} onClick={this.edit}/>  }
            </div>
