...
class LogInOrSignUp extends React.Component {
  ...
  setEmail = (e) => {
    this.setState({
      ...
      errorContent: "Valid email address is required.",
    });
    ...
    } else if (e.target.value === "") this.setState({ error: "none" });
    else {
          ...
          <div className="ssu_container" style={{ paddingBottom: "60px" }}>
            ...
            <div className="logIn_body">
              ...
              <ErrorState
                ...
                name={this.state.errorContent}
              />
              <div className="logIn_button" onClick={this.continueToNext}>
                CONTINUE
              </div>
              <p style={{ margin: "45px 0px 0px" }}>
                {" "}
                <img src={OR} style={{ width: "100%", height: "auto" }} />
              </p>
