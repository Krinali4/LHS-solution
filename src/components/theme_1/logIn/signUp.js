...
class SignUp extends React.Component {
  ...
  navTo = () => {
    console.log("this.state.navTo::",this.state.navTo)
    if (this.state.navTo) {
                ...
                <div
                  className={
                    this.state.hospitalSelected
                      ? "signUp_item signUp_item_selected"
                      : "signUp_item"
                  }
                  onClick={this.selectHospital}
                >
