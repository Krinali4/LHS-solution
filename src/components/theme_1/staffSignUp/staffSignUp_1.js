  ...
  return (
    <button
      ...
      style={{
        ...
        border: props.name === "ERROR" ? "2px solid red" : "1px solid #009CDE",
      }}
      id={props.name}
      onClick={() =>
...
class StaffSignUp_1 extends React.Component {
  ...
  componentWillMount() {
    console.log(this.props.redo,"this.props.redothis.props.redo")
        ...
        <div className="main_container" style={{ padding: "30px 0px 90px" }}>
          <div className="ssu_container">
            ...
            <div className="ssu1_body">
              <div className="ssu_txt1">What's your current location?</div>
