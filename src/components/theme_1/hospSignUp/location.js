...
class Loaction extends React.Component {
    ...
    setStreetErr = () => {
        ...
        this.setState({showStreetErr: true}); 
        window.localStorage.setItem("zip_code", this.state.zipCode);
        window.localStorage.setItem("hoscity", this.state.city);
        window.localStorage.setItem("hosstate", this.state.state);
        window.localStorage.setItem("hosstreet_address",  this.state.street);
        var location = {
