...
class HospSignUp_2 extends React.Component {
    ...
    continueToNext = () => {
        ...
        if( instName === 'none' && instSize === 'none' && instWebsite === 'none' && !this.state.showLocErr){
            ...
            // });
            window.localStorage.setItem("institution_name", this.state.instName);
            window.localStorage.setItem("institution_size", this.state.instSize);
            window.localStorage.setItem("institution_website", this.state.instWebsite);
        ...
        <div className="outer_container" style={{backgroundColor: '#009CDE'}}>
            <div className="main_container" style={{padding: '30px 0px 120px'}}>
                <div className="ssu_container">
                    <SubHeader num="2" title="Healthcare Institution" 
