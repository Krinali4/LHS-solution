...
class Part8 extends React.Component {
  ...
  subscribe = () => {
    if (this.state.email === "") this.setState({ error: "block" });
    else alert(this.state.email + " is subscribed to Our Mailing List.");
  };
  render() {
    return (
      <div className="landing_outer_container">
        <div className="outer_container" style={{ backgroundColor: "#009CDE" }}>
          <div className="row main_container part8_container">
            ...
            <div className="part8_text">
              Get the latest Job tips and medical news from{" "}
              <br className="part8_br" /> LinkHealthStaff delivered right to
              your email <br /> Send us your email address to sign up
            </div>
            <div
              className="part7_input_group part8_input_group"
              style={{ marginLeft: "auto", marginRight: "auto" }}
            >
              <div className="part7_input_email">
                <img src={email} width="100%" alt="icon" />
              </div>
              <input
                className="part7_input"
                placeholder="Email Address"
                value={this.state.email}
                onChange={this.setEmail}
              />
              <button className="part7_btn" onClick={this.subscribe}>
                SUBSCRIBE
              </button>
            </div>
